let ss = document.getElementById('ss-outer-container');
let ssInner = document.getElementById('scroll-bar-hider');
let ssText = document.getElementById('ss-container');
let close = document.getElementById('ss-close');
